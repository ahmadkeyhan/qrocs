...
export default function Features() {
    const featuresVsPrint = [
        ...
        },
        {
            ...
            description: "چه به دلیل خراب شدن طی گذر زمان، چه افزایش روزانه‌ی قیمت مواد اولیه، عمر منوهای چاپی کوتاهه و هزینه‌ی چاپ زیاد! ولی تغییر قیمت، اضافه کردن آیتم جدید و ... تو کردیت هیچ هزینه‌ای نداره!",
            color: "",
            image: ""
        },
        {
        ...
        },
        {
            ...
            description: "جا دادن اطلاعات محصول تو منوی چاپی به یک زبان کار سختیه؛ چه برسه به دو زبان! با کردیت میتونی منوی فارسی و انگلیسی(یا هر زبان دیگه‌ای) داشته باشی تا به مشتریان بیشتری سرویس بدی، مثل توریست‌ها!",
            color: "",
            image: ""
        },
        {
            title: "موجود/ناموجود کردن آیتم‌ها",
            description: "با منوی چاپی مجبورید به مشتریها بگید: شرمنده! فلان آیتم رو تموم کردیم! ولی با کردیت به راحتی آیتم‌ها رو ناموجود کنید، یا فقط در ساعات مشخصی از روز، یا روزهای معین هفته موجود کنید.",
            color: "",
            image: ""
        },
    ]
    ...
    const featuresVsDigital = [
        {
            title: "پنل ادمین",
            description: "اکثر منوهای دیجیتال پنل ادمین ندارن و هر تغییری باید توسط برنامه‌نویس اعمال بشه، ولی با داشبورد کردیت به راحتی میتونید هر موقع خواستید دسته‌بندی‌ها، آیتم‌ها، قیمت‌ها و حتی ظاهر منو رو تغییر بدید.",
            color: "",
            image: ""
        },
        {
            title: "موجود/ناموجود کردن آیتم‌ها",
            description: "اکثر منوهای دیجیتال قابلیت تغییر موجودی آیتم‌هارو ندارن، اگر هم داشته‌ باشن، دستی و تک به تک میتونید موجودی رو تغییر بدید! ولی با کردیت علاوه بر این، میتونید فقط در ساعات مشخصی از روز، یا روزهای معین هفته آیتمی رو موجود کنید.",
            color: "",
            image: ""
        },
        {
            title: "شخصی سازی ظاهر منو",
            description: "یه برند باید همه‌چیش باهم بخونه! کردیت به جای استفاده از قالب‌های آماده، رابط کاربری اختصاصی خودتو برات می‌سازه.",
            color: "",
            image: ""
        },
        {
            title: "پشتیبانی از چند شعبه",
            description: "وقتی مجموعه‌ای چند شعبه داره، داشتن منوی دیجیتال مشترک برای شعبه‌ها محدودیتهای خودش، و منوی دیجیتال متفاوت برای هر شعبه دردسرهای خودش رو داره! کردیت مدیریت منوی شعبه‌ها رو خیلی آسون کرده.",
            color: "",
            image: ""
        },
        // {
        //     title: "پشتیبانی از دو زبان",
        //     description: "اکثر منوهای دیجیتال فقط از یک زبان پشتیبانی میکنن! با کردیت میتونی منوی فارسی و انگلیسی(یا هر زبان دیگه‌ای) داشته باشی تا به مشتریان بیشتری سرویس بدی، مثل توریست‌ها!",
        //     color: "",
        //     image: ""
        // },
        {
  ...
  return (
    <div className="relative overflow-clip grid gap-4 sm:grid-cols-2 lg:grid-cols-3 w-full p-4 bg-gradient-to-b from-background to-foreground/5">
        <div className="flex flex-col gap-2 items-center text-center px-4 py-4 sm:col-span-2 lg:col-span-3 bg-background/70 backdrop-blur-md sticky top-[3.75rem] sm:top-[4.5rem] z-10">
            <h2 className="text-3xl text-primary">ویژگی‌های کردیت</h2>
            {/* <p className="text-lg">چرا منوی دیجیتال کردیت بهتر از منوی چاپی یا بقیه منوهای دیجیتاله؟</p> */}
