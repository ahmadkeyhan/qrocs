        ...
        return (
            <div className="grid sm:grid-cols-2 w-full p-4 max-w-5xl">
                <div className="flex flex-col text-center px-8 sm:px-2 items-center justify-center w-full">
                    ...
                    <p className="text-lg mb-4 text-foreground w-[32ch]">جای اینکه هر ماه منوی کافه یا رستوران رو دوباره چاپ کنی، با کردیت دیجیتالش کن تا مشتری‌ها با اسکن کیوآرکد به راحتی ببیننش!</p>
