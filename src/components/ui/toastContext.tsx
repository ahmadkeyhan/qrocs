...
function ToastItem({ toast, onClose }: { toast: Toast; onClose: () => void }) {
  ...
  return (
    <div
      className={cn(
        "rounded-3xl shadow-md relative p-4 transform transition-all duration-300 ease-in-out",
        bgColor[toast.type],
    ...
    >
      ...
      {toast.description && <p className="text-base text-subtext mt-1">{toast.description}</p>}
    </div>
  )
}
